...
$lang['ui']       = 'Interface style of the draw.io editor (kennedy is the default, atlas and min are more compact, sketch is hand-drawn, dark is the dark variant)';
$lang['theme']    = 'Colour mode of the draw.io editor: light always, dark always, or auto to follow the visitor\'s computer';
